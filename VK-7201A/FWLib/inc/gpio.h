...
#define  GPIO_MUX_TKKEY		(0x01)			/*触摸功能*/
 ...
 **			 使能GPIO为输出模式
 ** \param [in] PortTRIS ：方向寄存器 P0TRIS,P1TRIS,P2TRIS,P5TRIS  
 ...
 **			 GPIO上拉功能开启
 ** \param [in] PortUP  :上拉功能寄存器：P0UP,P1UP,P2UP,P5UP
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO下拉功能开启
 ** \param [in] PortRD  :下拉功能寄存器：P0RD,P1RD,P2RD,P5RD
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 **			 GPIO慢斜率功能开启
 ** \param [in] PortSR  :斜率控制功能寄存器：P0SR,P1SR,P2SR,P5SR
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
 ...
 ** \brief	 GPIO_SET_DS
 **			 置位数据输入选择寄存器
 ** \param [in] PortDS  :数据输入选择寄存器：P0DS,P1DS,P2DS,P5DS
 **            PinNum：GPIO_PIN_0...GPIO_PIN_7
 ** \return  none
 ******************************************************************************/
