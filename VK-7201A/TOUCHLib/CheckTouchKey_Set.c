...
unsigned int xdata g_CMS_RAM3[C_KEY_TOTAL];
unsigned int xdata g_CMS_RAM4[C_KEY_TOTAL];
unsigned int xdata g_CMS_RAM5[C_KEY_TOTAL];
unsigned int xdata g_CMS_RAM6[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM7[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM8[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM9[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM10[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM11[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM12[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM13[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM14[C_KEY_TOTAL];
unsigned char xdata g_CMS_RAM15[C_KEY_TOTAL];
...
unsigned char code g__CMS_Key_Disp = CMS_KEY_DISP;
